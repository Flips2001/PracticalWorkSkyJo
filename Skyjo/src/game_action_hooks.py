...
if TYPE_CHECKING:
    ...
    from Skyjo.src.game_state import RoundResult
...
class GameActionHooks(Protocol):
    ...
    def round_started(self, game: "SkyjoGame") -> None:
        """Called after setup and the opening discard are ready."""
        ...
    ...
    def round_scored(self, game: "SkyjoGame", result: "RoundResult") -> None:
        """Called before the scored round is reset and the next one is dealt."""
        ...
